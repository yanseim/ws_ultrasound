...
class MyInverseDynamicController: public controller_interface::MultiInterfaceController<
 ...
 private:
  ...
  Eigen::Matrix<double, 3, 3> orientation_d_matrix_;
  ...
  Eigen::Matrix<double, 6, 7> jacobian_analytic_last_;  
